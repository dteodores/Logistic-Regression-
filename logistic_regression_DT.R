...
NH11 <- readRDS("~/IDS_Course/logistic_regression/dataSets/NatHealth2011.rds")
...
NH11$r_maritl <- factor(NH11$r_maritl, levels=c("5 Divorced", "1 Married - spouse in household"))
str(NH11$r_maritl) # check new stucture of r_maritl
levels(NH11$r_maritl) # check new levels of r_maritl
